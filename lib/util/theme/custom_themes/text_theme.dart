...
class EcommerceTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w900, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w900, color: Colors.white),
